    ...
    <div class="w3-container w3-padding-16">
        ...
        <?php
                if (isset($_POST['txtCpf_mor'])) {
                    ...
                    echo '<a href="Mconsultar.php" class="w3-button w3-light-gray w3-round w3-margin">';
        ...
        ?>
            ...
            <div style="align-items: center;">
                <h2 style="flex-grow: 1; text-align: center;"><b>Consulta de Moradores</b></h2>
            </div><br>
            ...
            <?php
                ...
                if (isset($_POST['txtCpf_mor'])) {
                    ...
                    if ($resultado && $resultado->num_rows > 0) {
                        ...
                        echo '<label class="w3-text-black"><b>Endereço</b></label>';
                        echo '<input type="text" value="'.$linha['endereco'].'" readonly class="w3-input w3-border w3-round w3-small input-pequeno">';

                        echo '<label class="w3-text-black"><b>Complemento do Endereço</b></label>';
                        echo '<input type="text" value="'.$linha['compEndereco'].'" readonly class="w3-input w3-border w3-round w3-small input-pequeno">';

                        echo '<label class="w3-text-black"><b>Vaga de Garagem</b></label>';
                        echo '<input type="text" value="'.$linha['vagaGaragem'].'" readonly class="w3-input w3-border w3-round w3-small input-pequeno">';
                        echo '</div>';
                        echo '</div>';
                        ...
                        echo '<p>Nenhum morador encontrado.</p>';
                    }

                } else {
                    // Exibe a lista de todos os moradores
                    ...
                    echo '<tr>';
                    echo '<th>CPF</th><th>Nome</th><th>Telefone</th><th>Email</th><th>Veículo</th><th>Placa Veículo</th><th>Endereço</th><th>Complemento Endereço</th><th>Vaga Garagem</th>';
                    echo '</tr></thead><tbody>';
                    ...
                    if ($resultado != null) {
                        foreach($resultado as $linha) {
                            ...
                            echo '<td>' . $linha['compEndereco'] . '</td>';
                            echo '<td>' . $linha['vagaGaragem'] . '</td>';
                            echo '</tr>';
                        }
                    }
