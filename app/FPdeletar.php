...
<head>
 ...
 <title>Deletar - Funcionário/Prestador de Serviços</title>
 <style>
    .input-pequeno {
        width: 80%;
        height: 24px;
...
<body>
            ...
            <?php
                    if (isset($_POST['txtCpf_fEP'])) {
                        // Exibe os dados do Funcionário/Prestador de Serviços específico
                        echo '<a href="FPdeletar.php" class="w3-button w3-light-gray w3-round w3-margin">';
            ...
            ?>
                ...
                <div style="align-items: center;">
                    <h2 style="flex-grow: 1; text-align: center;"><b>Deletar Funcionário/Prestador de Serviços</b></h2>
                </div><br>
        ...
        <div class="w3-card w3-gray w3-padding-16 w3-round w3-margin-top">
            <form action="FPdeletarAc.php" method="post">
                <div class="w3-row-padding">
                    <!-- Coluna Esquerda: Formulário -->
                    <div class="w3-half">
                        <div class="input-container">
                            <input name="txtCpf_fEP" type="hidden" value="<?php echo $linha['cpf_fEP']; ?>">
