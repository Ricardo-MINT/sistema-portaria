    ...
    <div class="w3-card w3-gray w3-padding-4 w3-round w3-margin">
        ...
        <div style="align-items: center;">
            <a href="principal.php" class="w3-button w3-light-gray w3-round w3-margin">
                ...
                <h1 style="text-align: center;"><b>Cadastro de Visitantes</b></h1>
        </div><br>


        <form action="VcadastrarAc.php" method="POST" enctype="multipart/form-data">
            <div class="w3-row-padding">
                ...
                <div class="input-container">
                    ...
                    <input class="w3-input input-pequeno w3-border w3-round w3-small" type="text" name="txtCpf_vis" required
                ...
                <div class="input-container">
                    <label class="w3-text-black"><b>Situação</b></label>
                    <input class="w3-input input-pequeno w3-border w3-round w3-small" type="text" name="txtSituacao" required>
                </div>

                <div class="input-container">
                    <label class="w3-text-black"><b>Morador Vinculado</b></label>
