...
<title>Cadastrar Funcionário/Prestador de Serviços</title>
</head>
<body>
        ...
        <div class="w3-display-middle">
            ...
            <?php
               ...
               require_once ('config.php');
                ...
                $cnpjEmpresa = $_POST['txtCnpjEmpresa'];
                $telEmpresa = $_POST['txtTelEmpresa'];
                $emailEmp = $_POST['txtEmailEmp'];
                $ocupacao = $_POST['txtOcupacao'];
                $foto = $_POST['foto'];
                ...
                $sql = $conexao->prepare("INSERT INTO funcionarioseprestadores 
                    (cpf_fEP, nome, telefone, email, veiculo, placaVeiculo, empresa, cnpjEmpresa, telEmpresa, emailEmp, ocupacao, foto) 
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                $sql->bind_param("ssssssssssss", $cpf, $nome, $telefone, $email, $veiculo, $placaVeiculo, $empresa, 
                $cnpjEmpresa, $telEmpresa, $emailEmp, $ocupacao, $fotoPath);
