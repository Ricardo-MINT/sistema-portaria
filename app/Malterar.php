...
<div class="w3-container w3-padding-16">
        ...
        <?php
                if (isset($_POST['txtCpf_mor'])) {
                    ...
                    echo '<a href="Malterar.php" class="w3-button w3-light-gray w3-round w3-margin">';
        ...
        ?>
            ...
            <div style="align-items: center;">
                <h2 style="flex-grow: 1; text-align: center;"><b>Alterar Morador</b></h2>
            </div><br>
        ...
        <div class="w3-card w3-gray w3-padding-16 w3-round w3-margin-top">
                    ...
                    <form action="MalterarAc.php" method="post">
