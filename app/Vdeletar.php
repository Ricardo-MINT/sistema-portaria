...
<body>
            ...
            <?php
                    if (isset($_POST['txtCpf_vis'])) {
                        ...
                        echo '<a href="Vdeletar.php" class="w3-button w3-light-gray w3-round w3-margin">';
            ...
            ?>
                ...
                <div style="align-items: center;">
                    <h2 style="flex-grow: 1; text-align: center;"><b>Deletar Visitante</b></h2>
                </div><br>
        ...
        <div class="w3-card w3-gray w3-padding-16 w3-round w3-margin-top">
            <form action="VdeletarAc.php" method="post">
                <div class="w3-row-padding">
                    <!-- Coluna Esquerda: Formulário -->
                    <div class="w3-half">
                        <div class="input-container">
                            <input name="txtCpf_vis" type="hidden" value="<?php echo $linha['cpf_vis']; ?>">
