...
<head>
    ...
    <title>Cadastro - Funcionário/Prestador de Serviços</title>
    <style>
    ...
    <div class="w3-card w3-gray w3-padding-4 w3-round w3-margin">
        ...
        <div style="align-items: center;">
            <a href="principal.php" class="w3-button w3-light-gray w3-round w3-margin">
                ...
                <h1 style="text-align: center;"><b>Cadastro de Funcionário/Prestador de Serviços</b></h1>
        </div><br>


        <form action="FPcadastrarAc.php" method="POST" enctype="multipart/form-data">
            <div class="w3-row-padding">
                ...
                <div class="input-container">
                    ...
                    <input class="w3-input input-pequeno w3-border w3-round w3-small" type="text" name="txtCpf_fEP" required
                ...
                <div class="input-container">
                    <label class="w3-text-black"><b>Empresa</b></label>
                    <input class="w3-input input-pequeno w3-border w3-round w3-small" type="text" name="txtEmpresa" required>
                </div>

                <div class="input-container">
                    <label class="w3-text-black"><b>CNPJ da Empresa</b></label>
                    <input class="w3-input input-pequeno w3-border w3-round w3-small" type="text" name="txtCnpjEmpresa" required>
                </div>

                <div class="input-container">
                    <label class="w3-text-black"><b>Telefone da Empresa</b></label>
                    <input class="w3-input input-pequeno w3-border w3-round w3-small" type="text" name="txtTelEmpresa" required>
                </div>

                <div class="input-container">
                    <label class="w3-text-black"><b>Email da Empresa</b></label>
                    <input class="w3-input input-pequeno w3-border w3-round w3-small" type="text" name="txtEmailEmp" required>
                </div>

                <div class="input-container">
                    <label class="w3-text-black"><b>Ocupação</b></label>
                    <input class="w3-input input-pequeno w3-border w3-round w3-small" type="text" name="txtOcupacao" required>
                </div>
                </div>
