...
<head>
 ...
 <title>Atualizar - Funcionário/Prestador de Serviço</title>
</head>
<body>
    ...
    <!-- Caixa central com fundo light-gray -->
        <div class="w3-display-middle">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $sql = "UPDATE funcionarioseprestadores SET 
                                nome=?, telefone=?, email=?, veiculo=?, placaVeiculo=?, 
                                empresa=?, cnpjEmpresa=?, telEmpresa=?, emailEmp=?, ocupacao=? 
                            WHERE cpf_fEP=?";
                ...
                $stmt->bind_param("sssssssssss", 
                            ...
                            $placaVeiculo, $empresa, $cnpjEmpresa, 
                            $telEmpresa, $emailEmp, $ocupacao, $cpf_fEP);

                // Executando o statement
                if ($stmt->execute()) {
                    echo '<h1>Funcionário/Prestador de Serviços Atualizado com sucesso!</h1>';
                } else {
