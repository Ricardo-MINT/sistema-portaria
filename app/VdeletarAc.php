            ...
            <!-- Caixa central com fundo light-gray -->
                <div class="w3-display-middle">
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        $cpf_vis = $_POST['txtCpf_vis'];
                
                        // Exclui o morador do banco
                        $sql = "DELETE FROM visitantes WHERE cpf_vis=?";
                        ...
                        // Bind dos parâmetros
                        $stmt->bind_param("s", $cpf_vis);

                        // Executando o statement
                        if ($stmt->execute()) {
                            echo '<h1>Visitante Excluído com sucesso!</h1>';
                        } else {
                            echo '<h1>ERRO! Não foi possível excluir o visitante.</h1>';
